  ...
  return {
    DEFAULT: {
      css: {
        ...
        '--tw-prose-links': theme('colors.space-blue.500'),
        '--tw-prose-links-hover': theme('colors.space-blue.600'),
        '--tw-prose-links-underline': theme('colors.space-blue.500 / 0.3'),
        ...
        '--tw-prose-invert-links': theme('colors.space-blue.400'),
        '--tw-prose-invert-links-hover': theme('colors.space-blue.500'),
        '--tw-prose-invert-links-underline': theme(
          'colors.space-blue.500 / 0.3',
        ),
        ...
        fontFamily: theme('fontFamily.styrene-a'),
        ...
        h1: {
          ...
          fontFamily: theme('fontFamily.ark-project'),
